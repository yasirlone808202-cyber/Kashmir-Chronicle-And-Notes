          ...
          {payStep === "pay" && (
            <div className="space-y-5 py-2">
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 text-center">
                <p className="text-4xl font-bold text-amber-700 mb-2">₹ 5.00</p>
                <p className="text-sm text-amber-800 mb-4">Pay to FamPay ID: <span className="font-mono font-bold">8082029582@fam</span></p>
                <a href="upi://pay?pa=8082029582@fam&pn=YasirFerooz&am=5&cu=INR&tn=KashmirPortalNotes" className="block">
                  <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold h-12 rounded-xl" data-testid="button-upi-pay">
                    Open UPI App to Pay
                  </Button>
                </a>
              </div>
              <p className="text-sm text-center text-muted-foreground">After paying, come back here and click below</p>
              <Button onClick={() => setPayStep("submit")} variant="outline" className="w-full h-11 border-emerald-300 text-emerald-700 hover:bg-emerald-50" data-testid="button-paid-submit">
